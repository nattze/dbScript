...
FUNCTION GET_LINK_BKIAPP(i_db IN VARCHAR2) Return Varchar2 ;

FUNCTION GET_USER_NAME(I_id IN varchar2) RETURN varchar2 ; 

FUNCTION GET_USER_EMAIL(I_id IN varchar2) RETURN varchar2;
