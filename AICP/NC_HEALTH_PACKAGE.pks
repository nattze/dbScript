CREATE OR REPLACE PACKAGE AICP.NC_HEALTH_PACKAGE IS
  ...
  FUNCTION GEN_CLMNO(PROD_TYPE IN VARCHAR2 ,CHANNEL IN VARCHAR2) RETURN VARCHAR2;  

  FUNCTION GEN_PAYNO(PROD_TYPE IN VARCHAR2 ) RETURN VARCHAR2;  
    
  FUNCTION GEN_LETTNO(PROD_TYPE IN VARCHAR2 ) RETURN VARCHAR2;    
  
  FUNCTION GEN_LETTNO(PROD_TYPE IN VARCHAR2 ,V_KEY IN VARCHAR2) RETURN VARCHAR2;     
