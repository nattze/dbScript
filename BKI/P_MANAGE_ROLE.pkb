...
******************************************************************************/
    ...
    BEGIN
            ...
            for y in (
                select USER_ID, '∑¥ Õ∫' TITLE_T, NAME_T, '∑¥ Õ∫'  TITLE_E, NAME_E, DEPT, BRN_CODE, EMAIL, PASSWORD, DIV, TEAM, ORG_ID, DEPT_ID, DIV_ID, TEAM_ID, POSITION_GRP_ID , POSITION_ID, HR_ORG_ID, HR_DEPT_ID, HR_DIV_ID, HR_TEAM_ID, JOIN_DATE, CREATE_DATE, EXPIRED_DATE, HR_POSITION_GRP_ID, HR_POSITION_ID, POSITION_LEVEL, SUPERVISOR1_ID
                from bkiuser
