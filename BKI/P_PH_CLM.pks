CREATE OR REPLACE PACKAGE ALLCLM.P_PH_CLM AS
/******************************************************************************
   NAME:       P_PH_CLM
...
******************************************************************************/
    ...
    PROCEDURE GET_MAJOR_SUMINS_PRO(v_polno IN VARCHAR2 ,v_polrun IN NUMBER ,v_plan IN NUMBER ,sum_insured OUT SYS_REFCURSOR);
    ...
    */
    ...
    FUNCTION GET_ADMISSION_TYPE(v_clmno IN VARCHAR2) RETURN VARCHAR2 ; 
    
    FUNCTION GET_CLM_USER(v_clmno IN VARCHAR2) RETURN VARCHAR2;
    
    FUNCTION GET_APPRV_USER(v_clmno IN VARCHAR2 ,v_payno  IN VARCHAR2) RETURN VARCHAR2;
    ...
    FUNCTION CANCEL_APPROVE(vClmNo in varchar2 ,vPayNo in varchar2 ,vClmUser in varchar2 ,vRemark in varchar2 ,P_RST OUT VARCHAR2) RETURN NUMBER; -- 0 Fail ,1 Success 
    
    PROCEDURE email_alert_advance(i_clmno IN VARCHAR2 , i_payno IN VARCHAR2) ;
