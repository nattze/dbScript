...
BEGIN 
    ...
    Insert into ALLCLM.NC_PAYMENT
       ...
       (
        select clm_no, pay_no, trn_seq+1, pay_sts, pay_amt, trn_amt, curr_code, curr_rate, sts_date,sysdate amd_date, clm_men, amd_user, prod_grp, prod_type, sts_key, type, sub_type, prem_code, prem_seq, status, tot_pay_amt
        ,clm_seq ,SYSDATE SETTLE_DATE,offset_flag
        from nc_payment a
    ...
    Insert into ALLCLM.NC_PAYMENT_INFO
       ...
       (
        select clm_no, pay_no, type, prod_grp, prod_type, trn_seq +1, sts_date,sysdate amd_date, clm_user, sts_key
        ,part ,remark ,invoice_no,ref_no ,amd_user ,print_batch
    ...
    Insert into ALLCLM.NC_PAYEE
       ...
       (
        select clm_no, pay_no, prod_grp, prod_type, trn_seq +1, sts_date, sysdate amd_date, payee_code, payee_name, payee_type, payee_seq, payee_amt, settle, acc_no, acc_name, bank_code, bank_br_code, br_name, send_title, paid_sts, deduct_flag, type, sent_type, salvage_amt, deduct_amt, curr_code
        ,send_addr1 ,send_addr2 ,salvage_flag ,email ,sms ,appoint_date ,curr_rate ,agent_sms ,agent_email ,special_flag ,special_remark ,grp_payee_flag ,urgent_flag 
        from nc_payee a
    ...
    Insert into ALLCLM.NC_RI_PAID
       ...
       (
       select sts_key, clm_no, pay_no, prod_grp, prod_type, type, ri_code, ri_br_code, ri_type, ri_lf_flag, ri_sub_type, ri_share, trn_seq +1, ri_sts_date,sysdate ri_amd_date, ri_pay_amt, ri_trn_amt, status, sub_type
       ,lett_no ,lett_prt ,lett_type ,cashcall ,cancel ,print_type ,print_user ,print_date
        from nc_ri_paid a
