...
c_rec4 c4%rowtype; 
c_rec5 c5%rowtype;    
TYPE DEFINE_CLMNO IS VARRAY(100) OF VARCHAR2(20);
t_clmno   DEFINE_CLMNO ;    
TYPE DEFINE_PREMCODE IS VARRAY(100) OF VARCHAR2(20);
t_premcode   DEFINE_PREMCODE ;
TYPE DEFINE_AMT IS VARRAY(100) OF NUMBER;
t_amt   DEFINE_AMT ;    
TYPE DEFINE_PREMCOL IS VARRAY(100) OF NUMBER;
t_premcol   DEFINE_PREMCOL ;    
