     ...
     (  
      ...
      Loop 
        Begin 
         ...
         NC_RI_PAID.RI_LF_FLAG,NC_RI_PAID.RI_TYPE,NC_RI_PAID.RI_SUB_TYPE,NULL,NC_RI_PAID.RI_SHARE,NVL(NC_RI_PAID.RI_PAY_AMT,0)); 
         exception    
         when  OTHERS  then    
     ...
     (  
      ...
      Loop 
        Begin 
         ...
         VALUES(NC_RI_PAID.CLM_NO,NC_RI_PAID.PAY_NO,NC_RI_PAID.TRN_SEQ,v_type,NC_RI_PAID.RI_CODE,NC_RI_PAID.RI_BR_CODE, 
         NC_RI_PAID.RI_LF_FLAG,NC_RI_PAID.RI_TYPE,NC_RI_PAID.RI_SUB_TYPE,NULL,NC_RI_PAID.RI_SHARE,NVL(NC_RI_PAID.RI_PAY_AMT,0),0,0, 
         0,0,0,0); 
        exception    
        when  OTHERS  then    
                 v_err_message := 'MRN_RI_PAID';    
