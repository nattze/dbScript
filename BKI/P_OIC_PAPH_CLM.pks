...
******************************************************************************/
    ...
    PROCEDURE GET_PA_PAID(P_PAYNO IN VARCHAR2 ,V_CORR_SEQ IN NUMBER ,V_KEY OUT NUMBER , V_RST OUT VARCHAR2) ; 
    ...
    FUNCTION get_MAX_CLMSEQ(P_CLMNO IN VARCHAR2) RETURN NUMBER;
    
    PROCEDURE get_PA_TORBOR3(i_datefr IN DATE ,i_dateto IN DATE ,i_user IN VARCHAR2 ,o_rst OUT VARCHAR2);

    PROCEDURE get_GM_TORBOR3(i_datefr IN DATE ,i_dateto IN DATE ,i_user IN VARCHAR2 ,o_rst OUT VARCHAR2);
END P_OIC_PAPH_CLM;
/
